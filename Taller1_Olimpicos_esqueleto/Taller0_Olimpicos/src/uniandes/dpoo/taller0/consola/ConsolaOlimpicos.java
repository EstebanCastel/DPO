...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Ingrese el nombre de un atleta");
	...
	private void ejecutarbuscarAtleta() {
		String nombreAtleta = input("Ingrese un nombre");
		String nombrePais = calculadora.funcion1(nombreAtleta);
		System.out.println(" - " + "El atleta " +nombreAtleta +" es del país " + nombrePais);
